...
PATH_DATA_HVMV = PATH_DATA +'power_global/hvmv_global.gpkg'
PATH_DATA_PP = PATH_DATA +'power_global/global_power_plant_database.csv'
PATH_DATA_CT = PATH_DATA +'cell_towers/opencellid_global_1km_int.tif'
PATH_DATA_POP = PATH_DATA + 'population/'
...
PATH_EL_CONS_GLOBAL = PATH_DATA +'power_global/final_consumption_iea_global.csv'
...
while len(power_graph.graph.clusters())>1:
